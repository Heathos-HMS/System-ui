...
class _PharmacistsPageState extends State<PharmacistsPage> {
  ...
  StaffCategory _selectedTab = StaffCategory.pharmacists;
  ...
  void _onStaffTabSelected(StaffCategory category) {
    if (category == StaffCategory.pharmacists) return;
  ...
  void _addPharmacist() {
    // TODO: implement add pharmacist dialog/page
  }
      ...
      children: [
        Row(
          ...
          children: [
            ...
            _AddPharmacistButton(onTap: onAddPharmacist),
          ],
        ),
        const SizedBox(height: 20),
        _StaffTabs(selectedTab: selectedTab, onTabSelected: onTabSelected),
        const SizedBox(height: 0),
        _PharmacistsTable(pharmacists: pharmacists),
      ],
    );
  }
}

class _AddPharmacistButton extends StatelessWidget {
  final VoidCallback onTap;
  const _AddPharmacistButton({required this.onTap});
...
class _PharmacistsTable extends StatelessWidget {
  final List<Pharmacist> pharmacists;
  const _PharmacistsTable({required this.pharmacists});
    ...
    return Container(
      ...
      child: Column(
        children: [
         ...
         ...pharmacists.asMap().entries.map((entry) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                border: index < pharmacists.length - 1
              ...
              child: Row(
                children: [
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child:
                              pharmacist.avatarUrl!= null &&
                                  pharmacist.avatarUrl!.isNotEmpty
                             ? Image.network(
                  ...
                  Expanded(
                    ...
                    child: InkWell(
                      onTap: () {
                        // TODO: Navigate to pharmacist details
                      },
                      child: Row(
                        children: const [
                          Icon(
